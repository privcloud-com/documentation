...
|:-------------|:-------------| :-------------| :-------------| 
| /application/me| GET| application:get_me| Retrieve the current application |
...
| /container/{guid}/permission/{id}| PATCH| container:update_permission| Update a container permission by ID |
...
| /container/{guid}/permission| POST| container:create_permission| Create a new PrivCloud container permission associated with the container identified by guid |
...
| /record/{guid}/history/{history_guid}| POST| record:restore_from_history| Restore the content of the history entry identified by history_guid and make it the current version |
| /record/{guid}/history| GET| record:get_history| Retrieve the history of a record |
...
| /setting/auth_mode| GET| auth_mode_setting:get| Get the Auth Mode settings that are currently set |
...
| /setting/saml_idp_settings| GET| saml_idp_setting:get| Get the SAML IDP settings that are currently set |
...
| /user/me| GET| user:get_me| Retrieve the current user |
...
| /workflow/{id}/results| GET| workflow:get_results| Retrieve workflow results by ID |
| /workflow/{id}/test| POST| workflow:test| Test if there are no issues with the worflow you are trying to create |
| /workflow/{id}| DELETE| workflow:delete| Delete a workflow by ID |
| /workflow/{id}| GET| workflow:get| Retrieve a workflow by ID |
| /workflow/{id}| PATCH| workflow:update| Update a workflow by ID |
| /workflow| GET| workflow:list| Get a list of PrivCloud workflows |
| /workflow| POST| workflow:create| Create a new PrivCloud workflow |
| /workspace/test| POST| workspace:create_test| Create a new test PrivCloud workspace |
