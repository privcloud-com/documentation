...
## Examples
Examples of [permissions](examples/permissions) and [record types](examples/record_types) are in the examples directory. 
You can use these directly or modify them to your needs.
...
#### Record Metadata
Record metadata are key-value pairs that you can use to add context to your data or add additional fields that aren't a part 
